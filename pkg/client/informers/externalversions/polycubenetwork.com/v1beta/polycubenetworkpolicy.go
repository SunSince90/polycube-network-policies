	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolycubenetworkV1beta().PolycubeNetworkPolicies(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolycubenetworkV1beta().PolycubeNetworkPolicies(namespace).Watch(options)
			},
		},
		&polycubenetworkcomv1beta.PolycubeNetworkPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *polycubeNetworkPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&polycubenetworkcomv1beta.PolycubeNetworkPolicy{}, f.defaultInformer)
}
