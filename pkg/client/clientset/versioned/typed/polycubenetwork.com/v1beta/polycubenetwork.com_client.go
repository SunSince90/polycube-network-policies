...
type PolycubenetworkV1betaClient struct {
	restClient rest.Interface
}
...
func NewForConfig(c *rest.Config) (*PolycubenetworkV1betaClient, error) {
	config := *c
	...
	return &PolycubenetworkV1betaClient{client}, nil
}

// NewForConfigOrDie creates a new PolycubenetworkV1betaClient for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *PolycubenetworkV1betaClient {
...
// New creates a new PolycubenetworkV1betaClient for the given RESTClient.
func New(c rest.Interface) *PolycubenetworkV1betaClient {
	return &PolycubenetworkV1betaClient{c}
}
...
func (c *PolycubenetworkV1betaClient) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
